...
function buildModal(allowClose) {
  ...
  overlay.innerHTML = `
    <div class="login-modal__panel">
      <div class="login-modal__welcome-logo">
        <img src="assets/BULK_HUB_LOGO.png" alt="Bulk Hub" />
      </div>
      <div class="login-modal__header">
        <p class="eyebrow">Welcome</p>
        <h2>Bulk Hub</h2>
        <p class="muted">Your community analytics dashboard</p>
        <p class="login-modal__note">Registration is only needed for <strong>Global Map</strong>. You can skip and explore everything else without an account.</p>
      </div>
