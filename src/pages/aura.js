...
export function renderAura(target) {
  ...
  async function loadStats() {
    try {
      ...
      totalEl.textContent = s.total_aura != null ? fmtCompact(s.total_aura) : "Syncing...";
  ...
  function renderWalletResult(data) {
    ...
    walletResult.innerHTML = `
      <div class="aura-wallet-card">
        ...
        <div class="aura-wallet-card__row">
          <span class="aura-stat-label">Current Deposit</span>
          <span>${fmtUSD(data.current_amount)}</span>
        </div>
        <div class="aura-wallet-card__row">
          <span class="aura-stat-label">Total Deposited</span>
          <span>${fmtUSD(data.deposited_amount)}</span>
        </div>
        <div class="aura-wallet-card__row">
